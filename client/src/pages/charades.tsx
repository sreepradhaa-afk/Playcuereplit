...
export default function Charades() {
  ...
  const markWordShownMutation = useMutation({
    mutationFn: async (wordId: string) => {
      const response = await apiRequest("POST", "/api/charades/words/mark-shown", { wordId });
  ...
  const { data: categories = [] } = useQuery<string[]>({
    queryKey: ["/api/charades/categories"],
  });
  ...
  const filterWordsMutation = useMutation({
    mutationFn: async (params: { difficulty: CharadesDifficulty | "All"; categories: string[] }) => {
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="text-game-subtitle">
              Act it out! One player acts while others guess the word or phrase.
            </p>
          </div>
          ...
          <Card className="p-8 space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Select value={difficulty} onValueChange={(value) => setDifficulty(value as CharadesDifficulty | "All")}>
